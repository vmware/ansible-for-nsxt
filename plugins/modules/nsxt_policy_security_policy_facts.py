...
DOCUMENTATION = '''
---
module: nsxt_policy_security_policy_facts
short_description: List Policy Security Policies
description: Returns paginated list of policy security policies
...
def main():
    ...
    URL_query_spec = dict(
                            ...
                            include_rule_count=dict(type='bool',required=False),
